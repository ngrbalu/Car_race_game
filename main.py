...
yello_strip = pygame.image.load('yellow_strip.jpg')
...
def button(msg, x, y, w, h, ic, ac, action=None):
    ...
    if x+w > mouse[0] > x and y+h > mouse[1] > y:
        ...
        textsurf, textrect = text_objects(msg, samlltext)
...
def introduction():
    ...
    while introduction:
        ...
        textSurf, textRect = text_objects(
            "This is a car game in which you need dodge the coming cars", samlltext)
        ...
        stextSurf, stextRect = text_objects(
            "ARROW LEFT : LEFT TURN", samlltext)
        stextRect.center = ((150), (400))
        htextSurf, htextRect = text_objects(
            "ARROW RIGHT : RIGHT TURN", samlltext)
        htextRect.center = ((150), (450))
        atextSurf, atextRect = text_objects("A : Accelerator", samlltext)
        atextRect.center = ((150), (500))
        rtextSurf, rtextRect = text_objects("B : Break", samlltext)
        rtextRect.center = ((150), (550))
        ptextSurf, ptextRect = text_objects("P : PAUSE", samlltext)
        ptextRect.center = ((150), (350))
        sTextSurf, sTextRect = text_objects("Controls", samlltext)
        sTextRect.center = ((350), (3000))
...
def background():
    ...
    gamedisplays.blit(yello_strip, (400, 0))
    gamedisplays.blit(yello_strip, (400, 100))
    gamedisplays.blit(yello_strip, (400, 200))
    gamedisplays.blit(yello_strip, (400, 300))
    gamedisplays.blit(yello_strip, (400, 400))
    gamedisplays.blit(yello_strip, (400, 500))
...
def obstacle(obs_startx, obs_starty, obs):
    if obs == 0:
        obs_pics = pygame.image.load("car.jpg")
    elif obs == 1:
        obs_pics = pygame.image.load("car1.jpg")
    elif obs == 2:
        obs_pics = pygame.image.load("car2.jpg")
    elif obs == 3:
        obs_pics = pygame.image.load("car4.jpg")
    elif obs == 4:
        obs_pics = pygame.image.load("car5.jpg")
    elif obs == 5:
        obs_pics = pygame.image.load("car6.jpg")
    elif obs == 6:
        obs_pics = pygame.image.load("car7.jpg")

    gamedisplays.blit(obs_pics, (int(obs_startx), int(obs_starty)))
...
def conutdown_background():
    ...
    gamedisplays.blit(yello_strip, (400, 400))
    gamedisplays.blit(yello_strip, (400, 500))
    gamedisplays.blit(yello_strip, (400, 600))
    gamedisplays.blit(yello_strip, (400, 0))
    gamedisplays.blit(strip, (120, 0))
    gamedisplays.blit(strip, (120, 100))
    gamedisplays.blit(strip, (120, 200))
...
def game_loop():
    ...
    while not bumped:
        ...
        gamedisplays.blit(
            backgroundpic, (0, real_y-backgroundpic.get_rect().width))
        gamedisplays.blit(backgroundpic, (700, real_y -
                                          backgroundpic.get_rect().width))
        if real_y < 800:
            gamedisplays.blit(backgroundpic, (0, real_y))
            gamedisplays.blit(backgroundpic, (700, real_y))
            gamedisplays.blit(yello_strip, (400, real_y))
            gamedisplays.blit(yello_strip, (400, real_y+100))
            gamedisplays.blit(yello_strip, (400, real_y+200))
            gamedisplays.blit(yello_strip, (400, real_y+300))
            gamedisplays.blit(yello_strip, (400, real_y+400))
            gamedisplays.blit(yello_strip, (400, real_y+500))
            gamedisplays.blit(yello_strip, (400, real_y-100))
            gamedisplays.blit(strip, (120, real_y-200))
            gamedisplays.blit(strip, (120, real_y+20))
            gamedisplays.blit(strip, (120, real_y+30))
            gamedisplays.blit(strip, (680, real_y-100))
            gamedisplays.blit(strip, (680, real_y+20))
            gamedisplays.blit(strip, (680, real_y+30))
        y2 += obstacle_speed
